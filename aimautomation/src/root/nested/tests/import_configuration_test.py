...
class ImportConfigurationTest(BaseAimRegressionTest):
    ...
    def test_can_import_transmitter_configurations(self):
        ...
        self._page.click_transmitter_delete(self._page.get_list_of_transmitters()[0])
...
#         self._page.click_save()
    ...
    def test_can_import_recevier_configurations(self):
        ...
        self._page.click_receiver_delete(self._page.get_list_of_receivers()[0])
        self._page.click_lightbox_delete_button()
        self._page.open_dashboard_tab()
        self._page.click_dashboard_backups_link()
        self._page.click_import_configuration()
...
#         self._page.click_save()
    ...
    def test_can_import_channel_configurations(self):
        ...
        names = [self._page.get_channel_name(channel) for channel in self._page.get_list_of_channels()]
    ...
    def test_can_import_users_configuration(self):
        ...
        for user in self._page.get_list_of_users():
            if self._page.get_user_username(user) in ["admin", "anon", "api_anon"]:
                pass
            else:
        ...
        for user in self._page.get_list_of_users():
            self.assertTrue(self._page.get_user_username(user) in ["admin", "anon", "api_anon", "user 0", "user 1", "user 2", "user 3", "user 4"])
           
    """
    Utilities
    """
    def reset_number_of_channels(self):
        current_names = [self._page.get_channel_name(channel) for channel in self._page.get_list_of_channels()]
