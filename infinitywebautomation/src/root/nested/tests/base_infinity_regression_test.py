...
class BaseInfinityRegressionTest(unittest.TestCase):
    ...
    def setUp(self):
        ...
        self._invalid_ips = ["1.1.123123123.1", "abc.ade.ade.adf", "1.2", "192.168.16.255", " "]
        self._invalid_netmasks = ["255.255.123123123.1", "abc.ade.ade.adf", "1.2", " "] 
    ...
    def check_device_is_dual(self):
        if self._device == "RX" or self._device == "TX" or self._device == "RX2s" or self._device == "TX2s":
